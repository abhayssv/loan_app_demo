...
export class OverallCollectionService {
  ...
  getOverallCollectionsBusiness(offset: number, limit: number){
    return this.http.get(this.requestUrl + '/overall_business_collection/'+offset+'/'+limit).pipe(
      tap((res: any)=>{
        this.handleResponse(res);
      }),
      catchError(this.handleError<any>('OverallCollection'))
  ...
  searchLoan(value):Observable<User>{ 
    ...
    return this.http.get(environment.requestUrl + '/api/system_report/get/search_overall_business_collection?loan_id='+ loan_id+'&email='+email+'&mobile_no='+mobile_no+'&amount='+amount+'&assigned='+assigned+'&collection_team='+collection_team+'&from_date='+from_date+'&to_date='+to_date+'&id_number='+id_number+'&name='+name+'&overdue_days='+overdue_days+'&tenure='+tenure+'&user_type='+user_type).pipe(
      tap((res: any)=>{ 
        this.handleResponse(res);
      }),
      catchError(this.handleError<any>('OverallCollection'))
  ...
  getCollectionTeams():Observable<User>{
    return this.http.get(environment.requestUrl + '/api/system_report/get/business_collection_teams').pipe(
      tap((res: any)=>{
        this.handleResponse(res);
      }),
      catchError(this.handleError<any>('User'))
  ...
  getAssignerList():Observable<User>{
    return this.http.get(environment.requestUrl + '/api/system_report/get/business_assigner_list').pipe(
      tap((res: any)=>{
        this.handleResponse(res);
      }),
      catchError(this.handleError<any>('User'))

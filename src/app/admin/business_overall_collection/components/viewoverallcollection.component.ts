...
export class ViewOverallBusinessCollectionComponent implements OnInit {
  ...
  ngOnInit() {  
    this.overallcollections = this.route.snapshot.data['overallcollection'].data;
    ...
    this.overallCollectionService.getTransactionsByLoanId(loan_id).subscribe(res=>{ 
      if(res){ 

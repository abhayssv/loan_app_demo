...
import { ViewOverallCollectionComponent } from './components/viewoverallcollection.component';  
...
const routes: Routes = [
  ...
  { path:"view/:loan_id/:user_id", component: ViewOverallCollectionComponent, resolve:{ overallcollection: ViewOverallCollectionResolve} }, 
];

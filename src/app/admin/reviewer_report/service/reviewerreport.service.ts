...
export class ReviewerReportService {
  ...
  getReviewerLoanReport(offset: number, limit: number){
    return this.http.get(environment.requestUrl + '/api/system_report/collection/get_reviewers_report/'+offset+'/'+limit).pipe(
      tap((res: any)=>{
        this.handleResponse(res);
      }),
  ...
  getReviewerReport(value, offset, limit, isExport):Observable<User>{ 
    const {from_date, to_date, reviewer, status, assigned_users, loan_id, name, mobile_no, email, user_type, tenure, amount, id_number} = value; 
    return this.http.get(environment.requestUrl + '/api/system_report/reviewer/get_reports?from_date='+ from_date+'&to_date='+to_date+'&reviewer='+reviewer+'&status='+status+'&assigned_users='+assigned_users+'&loan_id='+loan_id+'&name='+name+'&mobile_no='+mobile_no+'&email='+email+'&user_type='+user_type+'&tenure='+tenure+'&amount='+amount+'&id_number='+id_number+'&offset='+offset+'&limit='+limit+'&isExport='+isExport).pipe(
      tap((res: any)=>{ 
        this.handleResponse(res);
      }),
      catchError(this.handleError<any>('ReviewerReport'))
    );
  } 
  ...
  getReviewerReportView(user_id: string): Observable<User>{
  ...
  deleteReviewerReport(user_id:number):Observable<{}> { 
  ...
  // Get Basic Information of App ReviewerReport....
  ...
  // Get Emp Information of App ReviewerReport....
  ...
  // Get Bank Information of App ReviewerReport....
  ...
  // Get KYC Information of App ReviewerReport....
